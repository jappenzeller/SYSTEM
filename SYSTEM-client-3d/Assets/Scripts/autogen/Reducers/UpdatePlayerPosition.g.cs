...
namespace SpacetimeDB.Types
{
    ...
    {
        public delegate void UpdatePlayerPositionHandler(ReducerEventContext ctx, DbVector3 position, DbQuaternion rotation);
        public event UpdatePlayerPositionHandler? OnUpdatePlayerPosition;

        public void UpdatePlayerPosition(DbVector3 position, DbQuaternion rotation)
        {
