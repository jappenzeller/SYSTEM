...
namespace SpacetimeDB.Types
{
    public sealed partial class RemoteReducers : RemoteBase
    {
        ...
        {
            if (OnCollectWavePacketOrb == null)
            {
    ...
    public abstract partial class Reducer
    {
        [SpacetimeDB.Type]
        [DataContract]
        public sealed partial class CollectWavePacketOrb : Reducer, IReducerArgs
        {
            ...
            string IReducerArgs.ReducerName => "collect_wave_packet_orb";
        }
    }

    public sealed partial class SetReducerFlags
    {
        internal CallReducerFlags CollectWavePacketOrbFlags;
        public void CollectWavePacketOrb(CallReducerFlags flags) => CollectWavePacketOrbFlags = flags;
    }
}
