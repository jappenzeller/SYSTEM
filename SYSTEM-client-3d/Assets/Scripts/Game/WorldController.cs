...
public class WorldController : MonoBehaviour
{
    ...
    [SerializeField] private string worldType = "Genesis"; // Set per prefab
    ...
    void Awake()
    {
        // UnityEngine.Debug.Log($"[WorldController] Initializing {gameObject.name}");
    ...
    {
        WorldController[] allWorlds = FindObjectsOfType<WorldController>();
    ...
    {
        // UnityEngine.Debug.Log("[WorldController] Initializing world components");
    ...
    void SetupPhysicsComponents()
    {
        ...
        {
            // UnityEngine.Debug.LogWarning("[WorldController] MeshCollider component missing. Adding one for physics.");
        ...
        // UnityEngine.Debug.Log($"[WorldController] Physics components ready - MeshCollider: {meshCollider != null}");
    }
    ...
    void ApplyWorldScale()
    {
        ...
        if (mf != null && mf.sharedMesh != null)
        {
            ...
            // UnityEngine.Debug.Log($"[WorldController] Mesh radius: {meshRadius}, Target world radius: {worldRadius}");
        ...
        // UnityEngine.Debug.Log($"[WorldController] World scale set to {targetScale} for radius {worldRadius}. Current scale: {transform.localScale}");
    ...
    public void SetWorldRotation(bool enable, float speed = 1f, Vector3? axis = null)
    {
        ...
        // UnityEngine.Debug.Log($"[WorldController] World rotation {(enable ? "enabled" : "disabled")} (speed: {speed})");
    }
...
{
    void Initialize(WorldController world);
    void Update();
    void Cleanup();
}
